...
import WinnerOverlay from "./GameMain/WinnerOverlay/WinnerOverlay";
...
import GameGrid from "./GameMain/GameGrid/GameGrid";
...
const GameMain = ({ summaryIsOpen, setSummaryIsOpen }) => {
  ...
  return (
    <section className={`${weather} w-full flex flex-col flex-grow min-h-screen`}>
      <Background />
      <GameHeader />
      <PlayerInfos />
      <GameGrid />
